...
a
[parallel programming model for architectures with that design](/gpu-glossary/device-software/cuda-programming-model.md),
...
[CUDA C++](/gpu-glossary/host-software/cuda-c.md) version.

This platform can be roughly divided into the components used to _build_
applications, like the
[NVIDIA CUDA Compiler Driver](/gpu-glossary/host-software/nvcc.md) toolchain, and
the components used _within_ or _from_ applications, like the
[CUDA Driver API](/gpu-glossary/host-software/cuda-driver-api.md) and the
[CUDA Runtime API](/gpu-glossary/host-software/cuda-runtime-api.md), diagrammed
below.
...
[kernels](/gpu-glossary/device-software/kernel.md) for general and specific
domains, like [cuBLAS](/gpu-glossary/host-software/cublas.md) for linear algebra
and [cuDNN](/gpu-glossary/host-software/cudnn.md) for deep neural networks.
