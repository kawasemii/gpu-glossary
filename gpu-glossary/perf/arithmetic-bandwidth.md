...
Arithmetic bandwidth is the [peak rate](/gpu-glossary/perf/peak-rate.md) at which
...
in a [roofline model](/gpu-glossary/perf/roofline-model.md) of the hardware.
...
[CUDA Cores](/gpu-glossary/device-hardware/cuda-core.md) for floating point
...
[Compute Unified Device Architecture (CUDA)](/gpu-glossary/device-hardware/cuda-device-architecture.md)
is that the [CUDA Cores](/gpu-glossary/device-hardware/cuda-core.md) and supporting
...
introduction of [Tensor Cores](/gpu-glossary/device-hardware/tensor-core.md), which
perform only matrix multiplication operations but do so at a much higher
arithmetic bandwidth than the
[CUDA Cores](/gpu-glossary/device-hardware/cuda-core.md) -- a ratio of 100:1
between [Tensor Core](/gpu-glossary/device-hardware/tensor-core.md) and
[CUDA Core](/gpu-glossary/device-hardware/cuda-core.md) bandwidth is a good rule of
thumb. That makes the [Tensor Core](/gpu-glossary/device-hardware/tensor-core.md)
arithmetic bandwidth the most important for
[kernels](/gpu-glossary/device-software/kernel.md) that wish to maximize
performance.

Contemporary GPUs have [Tensor Core](/gpu-glossary/device-hardware/tensor-core.md)
...
| **System (Compute / Memory)**                                                                                                                               | **Arithmetic Bandwidth (TFLOPs/s)** | **[Memory Bandwidth](/gpu-glossary/perf/memory-bandwidth.md) (TB/s)** | **[Ridge Point](/gpu-glossary/perf/roofline-model.md) (FLOPs/byte)** |
| :---------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------: | -----------------------------------------------------------------: | ----------------------------------------------------------------: |
