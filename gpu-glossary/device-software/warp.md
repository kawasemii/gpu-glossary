...
A warp is a group of [threads](/gpu-glossary/device-software/thread.md) that are
scheduled together and execute in parallel. All
[threads](/gpu-glossary/device-software/thread.md) in a warp are scheduled onto a
single
[Streaming Multiprocessor (SM)](/gpu-glossary/device-hardware/streaming-multiprocessor.md).
A single [SM](/gpu-glossary/device-hardware/streaming-multiprocessor.md) typically
...
aka [thread block](/gpu-glossary/device-software/thread-block.md).

Warps are the typical unit of execution on a GPU. In normal execution, all
[threads](/gpu-glossary/device-software/thread.md) of a warp execute the same
instruction in parallel — the so-called "Single-Instruction, Multiple Thread" or
SIMT model. When the [threads](/gpu-glossary/device-software/thread.md) in a warp
split from one another to execute different instructions, also known as
[warp divergence](/gpu-glossary/perf/warp-divergence.md), performance generally
drops precipitously.
...
[global memory](/gpu-glossary/device-software/global-memory.md), which generally
[go off-chip](/gpu-glossary/device-hardware/gpu-ram.md), it is also true for some
...
[SM](/gpu-glossary/device-hardware/streaming-multiprocessor.md), the
[Warp Scheduler](/gpu-glossary/device-hardware/warp-scheduler.md) will select
another warp to execute. This
[latency-hiding](/gpu-glossary/perf/latency-hiding.md) is how GPUs achieve high
...
[SM](/gpu-glossary/device-hardware/streaming-multiprocessor.md), ensuring there is
always an [eligible](/gpu-glossary/perf/warp-execution-state.md) warp for the
[SM](/gpu-glossary/device-hardware/streaming-multiprocessor.md) to run. The
fraction of cycles on which a warp was issued an instruction is known as the
[issue efficiency](/gpu-glossary/perf/issue-efficiency.md). The degree of
...
[thread hierarchy](/gpu-glossary/device-software/thread-hierarchy.md). Instead,
...
[cache lines](https://www.nic.uoregon.edu/~khuck/ts/acumem-report/manual_html/ch03s02.html.md)
...
[maximum performance](/gpu-glossary/perf.md).
