...
cuDNN provides highly optimized [kernels](/gpu-glossary/device-software/kernel.md)
...
[CUDA software platform](/gpu-glossary/host-software/cuda-software-platform.md),
alongside its sibling library, [cuBLAS](/gpu-glossary/host-software/cublas.md).
Deep learning frameworks like PyTorch typically leverage
[cuBLAS](/gpu-glossary/host-software/cublas.md) for general-purpose linear algebra,
...
single [kernel](/gpu-glossary/device-software/kernel.md). Operation fusion helps
reduce demand on [memory bandwidth](/gpu-glossary/perf/memory-bandwidth.md) by
keeping program intermediates in
[shared memory](/gpu-glossary/device-software/shared-memory.md) throughout a
...
[SM architectures](/gpu-glossary/device-hardware/streaming-multiprocessor-architecture.md),
