...
Unlike time spent [bottlenecked](/gpu-glossary/perf/performance-bottleneck.md) on
[compute](/gpu-glossary/perf/compute-bound.md) or
[memory](/gpu-glossary/perf/memory-bound.md), during which the GPU is working as
...
[kernel](/gpu-glossary/device-software/kernel.md) to launch, which can take many
...
number of device-side [kernels](/gpu-glossary/device-software/kernel.md) together
...
think of it as a form of [memory-boundedness](/gpu-glossary/perf/memory-bound.md)
