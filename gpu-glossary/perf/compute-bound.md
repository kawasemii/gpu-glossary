...
[Kernels](/gpu-glossary/device-software/kernel.md) that are compute-bound are
limited by the [arithmetic bandwidth](/gpu-glossary/perf/arithmetic-bandwidth.md)
of the [CUDA Cores](/gpu-glossary/device-hardware/cuda-core.md) or
[Tensor Cores](/gpu-glossary/device-hardware/tensor-core.md).

![In the [roofline diagram](/gpu-glossary/perf/roofline-model.md) above, [kernels](/gpu-glossary/device-software/kernel.md) underneath the blue line are compute-bound. Diagram adapted from [Williams, Waterman, and Patterson (2008)](https://people.eecs.berkeley.edu/~kubitron/cs252/handouts/papers/RooflineVyNoYellow.pdf) ([local copy here](../resources/RooflineVyNoYellow.pdf)).](../resources/terminal-roofline-model.svg)

Compute-bound kernels are characterized by high
[arithmetic intensity](/gpu-glossary/perf/arithmetic-intensity.md) (many arithmetic
operations per byte of memory loaded or stored).
[Utilization of arithmetic pipes](/gpu-glossary/perf/pipe-utilization.md) is the
limiting factor for a compute-bound kernel.

Technically, compute-boundedness is only defined for a single
[kernel](/gpu-glossary/device-software/kernel.md), as part of the
[roofline model](/gpu-glossary/perf/roofline-model.md), but with a bit of squinting
it can be generalized to cover the multiple
[kernels](/gpu-glossary/device-software/kernel.md) that make up a typical workload.
...
[shared memory](/gpu-glossary/device-software/shared-memory.md) once and then used
across many tokens.
...
one petaFLOP/s of
[arithmetic bandwidth](/gpu-glossary/perf/arithmetic-bandwidth.md) for 16-bit
...
[memory bandwidth](/gpu-glossary/perf/memory-bandwidth.md) of 1 PB/s (so that it
can load all 1 TB of weights in one ms). Contemporary
[memory bandwidths](/gpu-glossary/perf/memory-bandwidth.md) are in the TB/s range,
and so batches of hundreds of inputs are required to provide sufficient
[arithmetic intensity](/gpu-glossary/perf/arithmetic-intensity.md) for execution to
be compute-bound.
