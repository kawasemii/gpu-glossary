...
[hide latency](/gpu-glossary/perf/latency-hiding.md) with throughput.
...
analysis in
[the classic quantitative systems textbook by Lazowska and others](https://homes.cs.washington.edu/~lazowska/qsp/Images/Chap_03.pdf) ([local copy here](../resources/Chap_03.pdf)).

Little's Law determines how many instructions must be "in flight" for GPUs to
[hide latency](/gpu-glossary/perf/latency-hiding.md) through
[warp](/gpu-glossary/device-software/warp.md) switching by
[warp schedulers](/gpu-glossary/device-hardware/warp-scheduler.md) (aka
...
all [active warps](/gpu-glossary/perf/warp-execution-state.md) in a program. If the
...
[Vasily Volkov's PhD thesis](https://www2.eecs.berkeley.edu/Pubs/TechRpts/2016/EECS-2016-143.pdf) ([local copy here](../resources/EECS-2016-143.pdf))
on [latency hiding](/gpu-glossary/perf/latency-hiding.md): the number of warps
...
throughput. And because [memory bandwidth](/gpu-glossary/perf/memory-bandwidth.md)
is so much lower than
[arithmetic bandwidth](/gpu-glossary/perf/arithmetic-bandwidth.md), the required
