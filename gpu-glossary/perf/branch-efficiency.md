...
[warp](/gpu-glossary/device-software/warp.md) take the same execution path when
...
the level of [warps](/gpu-glossary/device-software/warp.md), and so branch
efficiency indicates the absence of
[warp divergence](/gpu-glossary/perf/warp-divergence.md).
...
[warps](/gpu-glossary/device-software/warp.md) will be composed of
[threads](/gpu-glossary/device-software/thread.md) that all have the same value for
the conditional, save for a single [warp](/gpu-glossary/device-software/warp.md)
whose [threads](/gpu-glossary/device-software/thread.md)' indices are above and
below `n`.
...
within [warps](/gpu-glossary/device-software/warp.md), whose
[threads](/gpu-glossary/device-software/thread.md) execute concurrently in time but
are mapped onto distinct data, and performance improves if those
[threads](/gpu-glossary/device-software/thread.md) branch uniformly.
