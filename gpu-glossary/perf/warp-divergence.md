...
[warp](/gpu-glossary/device-software/warp.md) take different execution paths due to
control flow statements.

For example, consider this [kernel](/gpu-glossary/device-software/kernel.md):
...
When the [threads](/gpu-glossary/device-software/thread.md) within a
[warp](/gpu-glossary/device-software/warp.md) encounter the data-dependent
conditional, some [threads](/gpu-glossary/device-software/thread.md) must execute
...
[PTX machine model](/gpu-glossary/device-software/parallel-thread-execution.md),
there is no way for a programmer or a compiler to avoid this split in control
flow inside of the [warp](/gpu-glossary/device-software/warp.md).

Instead, the [warp scheduler](/gpu-glossary/device-hardware/warp-scheduler.md) must
handle concurrent execution of these divergent code paths, which it achieves by
"masking" some [threads](/gpu-glossary/device-software/thread.md) so that they
...
[SASS](/gpu-glossary/device-software/streaming-assembler.md)
...
[threads](/gpu-glossary/device-software/thread.md) in the
[warp](/gpu-glossary/device-software/warp.md) execute `FSETP.GT.AND` concurrently
(`L2`), and each [thread](/gpu-glossary/device-software/thread.md) gets its own
`P0` value based on the `data` value in `R4`. Then, we have a bit of
[compiler](/gpu-glossary/host-software/nvcc.md) cleverness: in `L3` _all_
[threads](/gpu-glossary/device-software/thread.md) execute the code in A, writing
...
[warp](/gpu-glossary/device-software/warp.md) is said to be "divergent". On `L5`,
all [threads](/gpu-glossary/device-software/thread.md) are back to executing the
same code. Once the
[warp scheduler](/gpu-glossary/device-hardware/warp-scheduler.md) brings them back
...
[SASS](/gpu-glossary/device-software/streaming-assembler.md), which would instead
predicate both lines `L3` and `L4` — "presumably" in that we can trust the
[compiler](/gpu-glossary/host-software/nvcc.md) and in that, heuristically, we are
trading use of cheap, plentiful
[CUDA Core](/gpu-glossary/device-hardware/cuda-core.md) computation for more
...
(pre-Volta) GPUs, divergent [warps](/gpu-glossary/device-software/warp.md) were
